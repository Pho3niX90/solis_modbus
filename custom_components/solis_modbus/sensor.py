...
from homeassistant.components.sensor.const import STATE_CLASS_MEASUREMENT, SensorDeviceClass
from homeassistant.config_entries import ConfigEntry
from homeassistant.const import DEVICE_CLASS_TEMPERATURE, UnitOfFrequency, UnitOfTemperature, \
    DEVICE_CLASS_FREQUENCY, DEVICE_CLASS_VOLTAGE, UnitOfElectricPotential, UnitOfElectricCurrent, UnitOfPower, \
    DEVICE_CLASS_POWER, DEVICE_CLASS_CURRENT, POWER_VOLT_AMPERE_REACTIVE, UnitOfApparentPower, PERCENTAGE
...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry, async_add_entities):
    ...
    sensors = [
        {
            ...
            "entities": [
                {"type": "SS", "name": "Solis Inverter DC Voltage 1",
                 ...
                 "register": ['33049'], "device_class": DEVICE_CLASS_VOLTAGE,
                 "decimal_places": 1,
                ...
                {"type": "SS", "name": "Solis Inverter DC Current 1",
                 ...
                 "register": ['33050'], "device_class": DEVICE_CLASS_CURRENT,
                 "decimal_places": 1,
                ...
                {"type": "SS", "name": "Solis Inverter DC Voltage 2 ",
                 ...
                 "register": ['33051'], "device_class": DEVICE_CLASS_VOLTAGE,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricPotential.VOLT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter DC Current 2",
                 ...
                 "register": ['33052'], "device_class": DEVICE_CLASS_CURRENT,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter DC Voltage 3",
                 ...
                 "register": ['33053'], "device_class": DEVICE_CLASS_VOLTAGE,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricPotential.VOLT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter DC Current 3",
                 ...
                 "register": ['33054'], "device_class": DEVICE_CLASS_CURRENT,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter DC Voltage 4",
                 ...
                 "register": ['33055'], "device_class": DEVICE_CLASS_VOLTAGE,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricPotential.VOLT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter DC Current 4",
                 ...
                 "register": ['33056'], "device_class": DEVICE_CLASS_CURRENT,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter Total DC Output",
                 ...
                 "register": ['33057', '33058'], "device_class": DEVICE_CLASS_POWER,
                 "decimal_places": 0,
        ...
        },
        {
            ...
            "entities": [
                {"type": "SS", "name": "Solis Inverter DC Bus Half Voltage",
                 ...
                 "register": ['33072'], "device_class": DEVICE_CLASS_VOLTAGE,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricPotential.VOLT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter Active Power",
                 ...
                 "register": ['33079','33080'], "device_class": DEVICE_CLASS_POWER,
                 "decimal_places": 0,
                 "unit_of_measurement": UnitOfPower.WATT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                ...
                {"type": "SS", "name": "Solis Inverter Reactive Power",
                 ...
                 "register": ['33081', '33082'], "device_class": DEVICE_CLASS_POWER,
                 "decimal_places": 0,
                ...
                {"type": "SS", "name": "Solis Inverter Apparent Power",
                 ...
                 "register": ['33083', '33084'], "device_class": DEVICE_CLASS_POWER,
                 "decimal_places": 0,
        ...
        },
        {
            ...
            "entities": [
                {"type": "SS", "name": "Solis Inverter Temperature",
                 ...
                 "register": ['33093'], "device_class": DEVICE_CLASS_TEMPERATURE,
                 "decimal_places": 1,
                ...
                {"type": "SS", "name": "Solis Inverter Grid Frequency",
                 ...
                 "register": ['33094'], "device_class": DEVICE_CLASS_FREQUENCY,
                 "decimal_places": 2,
                ...
                {"type": "SS", "name": "Solis Lead-acid Battery Temperature",
                 ...
                 "register": ['33096'], "device_class": DEVICE_CLASS_TEMPERATURE,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfTemperature.CELSIUS,
                 "state_class": STATE_CLASS_MEASUREMENT},
            ]
        },
        {
            ...
            "entities": [
                ...
                {"type": "SS", "name": "Solis Inverter Battery Voltage",
                 ...
                 "register": ['33133'], "device_class": SensorDeviceClass.BATTERY,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricPotential.VOLT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                {"type": "SS", "name": "Solis Inverter Battery Current",
                 "unique": "solis_modbus_inverter_battery_current",
                 "register": ['33134'], "device_class": SensorDeviceClass.BATTERY,
                 "decimal_places": 1,
                 "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
                 "state_class": STATE_CLASS_MEASUREMENT},
        ...
        },
        {
            ...
            "entities": [
                {"type": "SS", "name": "Solis Inverter Household load power",
                 ...
                 "register": ['33147'], "device_class": SensorDeviceClass.CURRENT,
                 "decimal_places": 0,
                 "unit_of_measurement": UnitOfPower.WATT,
                 "state_class": STATE_CLASS_MEASUREMENT},
                {"type": "SS", "name": "Solis Inverter Backup load power",
                 "unique": "solis_modbus_inverter_backup_load_power",
                 "register": ['33148'], "device_class": SensorDeviceClass.CURRENT,
                 "decimal_places": 0,
                 "unit_of_measurement": UnitOfPower.WATT,
                 "state_class": STATE_CLASS_MEASUREMENT},
            ]
    ...
    def async_update(now):
        _LOGGER.warning('sensor async_update')
        ...
        for sensor_group in sensors:
            ...
            _LOGGER.warning(f'start_register = {start_register}, value = {values}')
            for i, value in enumerate(values):
                register_key = f"{start_register + i}"
                hass.data[DOMAIN]['values'][register_key] = value
                _LOGGER.warning(f'register_key = {register_key}, value = {value}')
...
class SolisSensor(SensorEntity):
    ...
    def __init__(self, hass, modbus_controller, entity_definition):
        ...
        self.entity_id = f"sensor.{slugify(entity_definition['name']).replace('-', '_')}"
        _LOGGER.warning(f'INIT = {self.entity_id}')
    ...
    async def async_added_to_hass(self) -> None:
        ...
        _LOGGER.warning("async_added_to_hasss %s", self._attr_name)
        self.is_added_to_hass = True

    def update(self):
        _LOGGER.warning('sensor update')
        ...
        try:
            ...
            self._state = n_value
            _LOGGER.warning(f'register name = {self._attr_name}, value = {n_value}, state = {self.state}')
