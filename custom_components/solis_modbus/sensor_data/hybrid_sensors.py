...
hybrid_sensors = [
    {
        ...
        "entities": [
            ...
            {"name": "Solis DSP Version", "unique": "solis_modbus_inverter_dsp_version",
             "register": ['33001'], "multiplier": 0},
            {"name": "Solis HMI Version", "unique": "solis_modbus_inverter_hmi_version",
             "register": ['33002'], "multiplier": 0},
            {"name": "Solis Protocol Version", "unique": "solis_modbus_inverter_protocol_version",
             "register": ['33003'], "multiplier": 0},
            {"name": "Solis Serial Number", "unique": "solis_modbus_inverter_serial_number",
             "register": [
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis PV Current Month Energy Generation",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis PV Last Month Energy Generation",
            ...
            {"name": "Solis PV Today Energy Generation",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis PV Yesterday Energy Generation",
            ...
            {"name": "Solis PV This Year Energy Generation",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis PV Last Year Energy Generation",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Grid Frequency", "unique": "solis_modbus_inverter_grid_frequency",
            ...
            {"name": "Solis Status", "unique": "solis_modbus_inverter_current_status",
             "register": ['33095'], "multiplier": 0, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Lead-acid Battery Temperature",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Battery Current (BMS)",
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Battery Charge Current Limitation (BMS)",
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Battery Discharge Current Limitation (BMS)",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Today Battery Charge Energy",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Yesterday Battery Charge Energy",
            ...
            {"name": "Solis Today Battery Discharge Energy",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Yesterday Battery Discharge Energy",
            ...
            {"name": "Solis Today Energy Imported From Grid",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Yesterday Energy Imported From Grid",
            ...
            {"name": "Solis Today Energy Fed Into Grid",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Yesterday Energy Fed Into Grid",
            ...
            {"name": "Solis Today Energy Consumption",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Yesterday Energy Consumption",
    ...
    },
    {
        ...
        "entities": [
            {"name": "Solis Parallel Inverter AC Current",
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Parallel Inverter AC Voltage",
             ...
             "unit_of_measurement": UnitOfElectricPotential.VOLT, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Parallel Inverter Power",
    ...
    },
    {
        ...
        "entities": [
            {"name": "Solis SmartPort A Phase Voltage",
             ...
             "unit_of_measurement": UnitOfElectricPotential.VOLT, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis SmartPort B Phase Voltage",
             ...
             "unit_of_measurement": UnitOfElectricPotential.VOLT, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis SmartPort C Phase Voltage",
            ...
            {"name": "Solis SmartPort A Phase Current",
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis SmartPort B Phase Current",
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis SmartPort C Phase Current",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Generator Total Energy",
             ...
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "Solis Generator Phase B Active Power",
             ...
             "unit_of_measurement": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Generator Phase C Active Power",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Battery Force-charge Power Limitation",
             ...
             "default": 3000.0,
             "min": 0, "max": 6000},
            {"name": "Solis Battery Force Charge Source",
    ...
    },
    {
        ...
        "entities": [
            {"name": "Solis RC Force Battery Charge/discharge",
            ...
            {"name": "Solis RC Force Battery Charge Power",
            ...
            {"name": "Solis Off-Grid Overdischarge SOC",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Time-Charging Discharge Current",
            ...
            {"name": "Solis Time-Charging Charge Start Hour (Slot 1)",
             ...
             "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Time-Charging Charge Start Minute (Slot 1)",
            ...
            {"name": "Solis Time-Charging Discharge Start Minute (Slot 1)",
             "unique": "solis_modbus_inverter_time_discharge_start_minute_slot1", "register": ['43148'],
             "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Time-Charging Discharge End Hour (Slot 1)",
             "unique": "solis_modbus_inverter_time_discharge_end_hour_slot1", "register": ['43149'],
             "multiplier": 0, "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Time-Charging Discharge End Minute (Slot 1)",
    ...
    },
    {
        ...
        "entities": [
            {"name": "Solis Forced Start of Generator",
            ...
            {"name": "Solis Rated Input Power of Generator",
            ...
            {"name": "Solis Generator Target Power",
            ...
            {"name": "Solis Generator Charging Power",
    ...
    },
    {
        ...
        "entities": [
            {"name": "Solis Time of Use V2 Switch", "register": ['43707'],
             "unique": "solis_modbus_inverter_tou_v2_switch"},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 1)", "register": ['43708'],
             ...
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 1)", "register": ['43709'],
            ...
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 1)", "register": ['43710'],
            ...
            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 1)", "register": ['43711'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 1)", "register": ['43712'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 1)", "register": ['43713'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 1)", "register": ['43714'],
             "unique": "solis_modbus_inverter_tou_charge_end_minute_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 2)", "register": ['43715'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_charge_2", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 2)", "register": ['43716'],
             "unique": "solis_modbus_inverter_tou_charge_v2_battery_current_2", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 2)", "register": ['43717'],
             "unique": "solis_modbus_inverter_tou_charge_v2_cutoff_voltage_2", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 2)", "register": ['43718'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 2)", "register": ['43719'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 2)", "register": ['43720'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 2)", "register": ['43721'],
             "unique": "solis_modbus_inverter_tou_charge_end_minute_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 3)", "register": ['43722'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_charge_3", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 3)", "register": ['43723'],
             "unique": "solis_modbus_inverter_tou_charge_v2_battery_current_3", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 3)", "register": ['43724'],
             "unique": "solis_modbus_inverter_tou_charge_v2_cutoff_voltage_3", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 3)", "register": ['43725'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 3)", "register": ['43726'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 3)", "register": ['43727'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 3)", "register": ['43728'],
             "unique": "solis_modbus_inverter_tou_charge_end_minute_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 4)", "register": ['43729'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_charge_4", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 4)", "register": ['43730'],
             "unique": "solis_modbus_inverter_tou_charge_v2_battery_current_4", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 4)", "register": ['43731'],
             "unique": "solis_modbus_inverter_tou_charge_v2_cutoff_voltage_4", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 4)", "register": ['43732'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 4)", "register": ['43733'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 4)", "register": ['43734'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 4)", "register": ['43735'],
             "unique": "solis_modbus_inverter_tou_charge_end_minute_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 5)", "register": ['43736'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_charge_5", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 5)", "register": ['43737'],
             "unique": "solis_modbus_inverter_tou_charge_v2_battery_current_5", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 5)", "register": ['43738'],
             "unique": "solis_modbus_inverter_tou_charge_v2_cutoff_voltage_5", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 5)", "register": ['43739'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 5)", "register": ['43740'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 5)", "register": ['43741'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 5)", "register": ['43742'],
             "unique": "solis_modbus_inverter_tou_charge_end_minute_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Charge cut off SOC (Slot 6)", "register": ['43743'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_charge_6", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Charge battery current (Slot 6)", "register": ['43744'],
             "unique": "solis_modbus_inverter_tou_charge_v2_battery_current_6", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge cut off voltage (Slot 6)", "register": ['43745'],
             "unique": "solis_modbus_inverter_tou_charge_v2_cutoff_voltage_6", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Charge Start Hour (Slot 6)", "register": ['43746'],
             "unique": "solis_modbus_inverter_tou_charge_start_hour_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge Start Minute (Slot 6)", "register": ['43747'],
             "unique": "solis_modbus_inverter_tou_charge_start_minute_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Hour (Slot 6)", "register": ['43748'],
             "unique": "solis_modbus_inverter_tou_charge_end_hour_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Charge End Minute (Slot 6)", "register": ['43749'],
        ...
        "entities": [
            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 1)", "register": ['43750'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_1", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 1)", "register": ['43751'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_1", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 1)", "register": ['43752'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_1", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 1)", "register": ['43753'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 1)", "register": ['43754'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 1)", "register": ['43755'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 1)", "register": ['43756'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_1", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 2)", "register": ['43757'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_2", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 2)", "register": ['43758'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_2", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 2)", "register": ['43759'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_2", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 2)", "register": ['43760'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 2)", "register": ['43761'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 2)", "register": ['43762'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 2)", "register": ['43763'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_2", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 3)", "register": ['43764'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_3", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 3)", "register": ['43765'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_3", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 3)", "register": ['43766'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_3", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 3)", "register": ['43767'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 3)", "register": ['43768'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 3)", "register": ['43769'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 3)", "register": ['43770'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_3", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 4)", "register": ['43771'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_4", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 4)", "register": ['43772'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_4", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 4)", "register": ['43773'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_4", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 4)", "register": ['43774'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 4)", "register": ['43775'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 4)", "register": ['43776'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 4)", "register": ['43777'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_4", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 5)", "register": ['43778'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_5", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 5)", "register": ['43779'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_5", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 5)", "register": ['43780'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_5", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 5)", "register": ['43781'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 5)", "register": ['43782'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 5)", "register": ['43783'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 5)", "register": ['43784'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_5", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},

            {"name": "Solis Grid Time of Use Discharge cut off SOC (Slot 6)", "register": ['43785'],
             "unique": "solis_modbus_inverter_tou_charge_cutoff_discharge_6", "multiplier": 1,
             "unit_of_measurement": PERCENTAGE, "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0,
             "max": 100},
            {"name": "Solis Grid Time of Use Discharge battery current (Slot 6)", "register": ['43786'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_battery_current_6", "multiplier": 0.1,
             "device_class": SensorDeviceClass.CURRENT, "unit_of_measurement": UnitOfElectricCurrent.AMPERE,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},
            {"name": "Solis Grid Time of Use Discharge cut off voltage (Slot 6)", "register": ['43787'],
             "unique": "solis_modbus_inverter_tou_discharge_v2_cutoff_voltage_6", "multiplier": 0.1,
             "device_class": SensorDeviceClass.VOLTAGE, "unit_of_measurement": UnitOfElectricPotential.VOLT,
             "state_class": SensorStateClass.MEASUREMENT, "editable": True, "min": 0, "max": 300},

            {"name": "Solis Grid Time of Use Discharge Start Hour (Slot 6)", "register": ['43788'],
             "unique": "solis_modbus_inverter_tou_discharge_start_hour_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge Start Minute (Slot 6)", "register": ['43789'],
             "unique": "solis_modbus_inverter_tou_discharge_start_minute_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Hour (Slot 6)", "register": ['43790'],
             "unique": "solis_modbus_inverter_tou_discharge_end_hour_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.HOURS, "state_class": SensorStateClass.MEASUREMENT},
            {"name": "Solis Grid Time of Use Discharge End Minute (Slot 6)", "register": ['43791'],
             "unique": "solis_modbus_inverter_tou_discharge_end_minute_6", "multiplier": 0,
             "unit_of_measurement": UnitOfTime.MINUTES, "state_class": SensorStateClass.MEASUREMENT},
        ]
    }, {
        "register_start": 43815,
        "entities": [{"name": "Solis Generator charging switch",
    ...
    },
    {
        ...
        "entities": [{"name": "Solis Generator Set Enable Switch",
    ...
    },
    {
        ...
        "entities": [{"name": "Solis Hybrid Function Control",
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Solis Peak Max Usable Grid Power",
