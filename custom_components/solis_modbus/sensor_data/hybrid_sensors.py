...
hybrid_sensors = [
    ...
    },
    {
        ...
        "entities": [
            ...
            {"type": "reserve",
             "register": ['33059', '33060', '33061', '33062', '33063', '33064', '33065', '33066', '33067', '33068',
                          '33069']},
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Battery Current", "category": Category.BATTERY_INFORMATION,
             ...
             "state_class": SensorStateClass.MEASUREMENT, "data_type": "S16"},
            ...
            {"name": "Battery Current (BMS)", "category": Category.BATTERY_INFORMATION,
             ...
             "unit_of_measurement": UnitOfElectricCurrent.AMPERE, "state_class": SensorStateClass.MEASUREMENT, "data_type": "S16"},
    ...
    },
    {
        ...
        "entities": [
            {"name": "AC Coupling Total Power Generation", "category": Category.AC_INFORMATION,
             ...
             "register": ['34445', '34446'], "device_class": SensorDeviceClass.ENERGY, "multiplier": 1,
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "AC Coupling Year Power Generation", "category": Category.AC_INFORMATION,
             "unique": "solis_modbus_inverter_ac_coupling_year_power_generation",
             "register": ['34447', '34448'], "device_class": SensorDeviceClass.ENERGY, "multiplier": 1,
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "AC Coupling Month Power Generation", "category": Category.AC_INFORMATION,
             "unique": "solis_modbus_inverter_ac_coupling_month_power_generation",
             "register": ['34449', '34450'], "device_class": SensorDeviceClass.ENERGY, "multiplier": 1,
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "AC Coupling Today Power Generation", "category": Category.AC_INFORMATION,
             "unique": "solis_modbus_inverter_ac_coupling_today_power_generation",
             "register": ['34451'], "device_class": SensorDeviceClass.ENERGY, "multiplier": 0.1,
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
            {"name": "AC Coupling Yesterday Power Generation", "category": Category.AC_INFORMATION,
             "unique": "solis_modbus_inverter_ac_coupling_yesterday_power_generation",
             "register": ['34452'], "device_class": SensorDeviceClass.ENERGY, "multiplier": 0.1,
             "unit_of_measurement": UnitOfEnergy.KILO_WATT_HOUR, "state_class": SensorStateClass.TOTAL_INCREASING},
        ]
    },
    {
        ...
        "entities": [
            {"name": "AC Coupling Total Active Power", "category": Category.AC_INFORMATION,
             ...
             "register": ['34496', '34497'], "device_class": SensorDeviceClass.POWER, "multiplier": 1,
             "unit_of_measurement": UnitOfPower.WATT, "state_class": SensorStateClass.MEASUREMENT},
        ]
    },
    {
    ...
    },
    {
        ...
        "entities": [
            ...
            {"name": "Flexible Export Enabling Switch",
             "unique": "solis_modbus_inverter_flexible_export_enabling_switch", "category": Category.GRID_CODE_SETTING,
